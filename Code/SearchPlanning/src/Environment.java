...
//				System.out.println(col + " " + row);
				...
				switch(tile) {
				case 'R': tiles[row][col] = new Tile(TileStatus.CLEAN); robotPos.setRow(row); robotPos.setCol(col); break;
	...
	/*
	 * Returns the status of a tile at a given [row][col] coordinate
	 */
